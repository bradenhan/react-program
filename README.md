...
# 项目缘起：
最近在学习一下react,所以才有这个项目。 
此项目，使用 [Create React App](https://github.com/facebookincubator/create-react-app)创建。
...
* `create-react-app` 命令  
```
  npm install -g create-react-app //全局安装reate-react-app
...
|____favicon.ico
|__src
|____component //存放模块的目录
|______xxx.js
|______xxx.js
|____less  //存放less的目录
|______component  //存放模块less的目录
|________xxx.less
|______lib  //存放less公共模块的目录
|________mixins.less // CSS3集合less文件
|______xxx.less 
|____App.css
|____App.js
|____App.test.js
